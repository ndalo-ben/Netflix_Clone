            ...
            <ul className='flex gap-8 p-0 my-[25px]'>
                    ...
                    accounts && accounts.length ? accounts.map((item) => (
                        <li
                            ...
                            <div className="relative">
                                <Image height={200} width={200} src="/netflix.png" alt="Account" className='max-w-[200px] rounded min-w-[84px] max-h-[200px] min-h-[84px] object-cover w-[155px] h-[155px]' />
                                {
                                    showDeleteIcon ? (
...

                {
                    accounts && accounts.length < 4 ? (
                        <li onClick={() => setShowAccountForm(!showAccountForm)} className="border text-black bg-[#e5b109] font-bold text-lg border-black max-w-[200px] rounded min-w-[84px] max-h-[200px] min-h-[84px] cursor-pointer flex items-center justify-center w-[155px] h-[155px]">
                            Add Account
                        </li>
                    ) : null
                }
